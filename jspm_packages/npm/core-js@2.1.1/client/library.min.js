...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var l,
          ...
          k = !!function() {
            try {
              ...
              return b(11)(e, b(23)("species"), {value: c}), (o || "function" == typeof PromiseRejectionEvent) && a.then(i) instanceof c;
            } catch (f) {}
          }(),
          A = function(a, b) {
            return a === b || a === d && b === y;
      ...
      }), c(c.G + c.W + c.F * !k, {Promise: d}), b(22)(d, e), b(179)(e), y = b(3)[e], c(c.S + c.F * !k, e, {reject: function reject(b) {
          var a = j(this),
              c = a.reject;
          return c(b), a.promise;
        }}), c(c.S + c.F * (C || !k), e, {resolve: function resolve(a) {
          if (a instanceof d && A(a.constructor, this))
            return a;
          var b = j(this),
              c = b.resolve;
          return c(a), b.promise;
        }}), c(c.S + c.F * !(k && b(151)(function(a) {
        d.all(a)["catch"](i);
      })), e, {
        all: function all(g) {
          var c = this,
      ...
      var b = c(187);
      d.exports = c(188)("Map", function(b) {
        return function Map() {
      ...
      var c = b(187);
      d.exports = b(188)("Set", function(b) {
        return function Set() {
          return b(this, arguments.length > 0 ? arguments[0] : a);
        };
      }, {add: function add(a) {
      ...
      var d,
          ...
          e = q.exports = b(188)("WeakMap", g, f, c, !0, !0);
 ...
 while (!((c = d[b._i++]) in b._t));
      ...
      var a = b(7);
      a(a.G + a.W + a.F * !b(212).ABV, {DataView: b(213).DataView});
    }, function(b, c, a) {
      a(216)("Int8", 1, function(a) {
      ...
      var a = b(7);
      a(a.P + a.R, "Map", {toJSON: b(238)("Map")});
    }, function(b, e, a) {
      var c = a(150),
          d = a(239);
      b.exports = function(a) {
      ...
      var a = b(7);
      a(a.P + a.R, "Set", {toJSON: b(238)("Set")});
    }, function(c, d, a) {
      var b = a(7);
