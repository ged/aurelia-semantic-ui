...
(function(process) {
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      var USE_NATIVE = !!function() {
        try {
          var promise = $Promise.resolve(1),
              FakePromise1 = promise.constructor = function(exec) {
                exec(empty, empty);
              },
              FakePromise2 = function(exec) {
                exec(empty, empty);
              };
          __webpack_require__(9)(FakePromise1, __webpack_require__(23)('species'), {value: FakePromise2});
      ...
      var $export = __webpack_require__(7);
      $export($export.G + $export.W + $export.F * !__webpack_require__(226).ABV, {DataView: __webpack_require__(227).DataView});
    }, function(module, exports, __webpack_require__) {
